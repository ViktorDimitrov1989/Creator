...
import static app.constants.ClassTemplates.CONTROLLER_TEMPLATE;

public class Controllers extends BaseCreateStrategy {
    @Override
    ...
    private static void createControllerClass(Class<?> clazz, String path) throws IOException {
        ...
        try (PrintWriter printWriter = new PrintWriter(controller)) {
            ...
            printWriter.println(String.format(CONTROLLER_TEMPLATE,
