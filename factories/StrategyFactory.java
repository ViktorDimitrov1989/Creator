...
public final class StrategyFactory {
    ...
    public static CreateStrategy getStrategy(String strategyClassPath)
    ...
    public static List<CreateStrategy> getStrategies(String multipleStrategyName, String strategyClassPath)
            throws IllegalAccessException,
            InvocationTargetException,
            InstantiationException,
            ClassNotFoundException,
        ...
        if (strategiesNames[0].equals("Exam")) {
            strategiesNames = new String[]{"AddDto", "Repositories", "ServicesExam"};
        }
